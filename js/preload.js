function aviso(){
    ...
    document.getElementById("bodyParte").innerHTML += '<div id="login"><div id="loginDiv">    <form><label for="User">Usuário</label><br><input type="text"><br><label for="password">Senha</label> <br> <input type="password"> <a href="paginas/index.html">   <input id="btnEnvia" type="button" value="Entrar"> </a> </form> </div> </div>'
}
